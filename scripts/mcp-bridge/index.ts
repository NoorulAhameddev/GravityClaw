    ...
    tools: [
      {
        ...
        description:
          'Delegate a complex sub-task or research question to your parallel AI co-pilot, Antigravity. This runs asynchronously. You will receive a taskId to check status later.',
        inputSchema: {
          type: 'object',
          properties: {
            ...
            instructions: {
              type: 'string',
              description: 'Detailed instructions and context for what Antigravity needs to do.',
            },
          },
