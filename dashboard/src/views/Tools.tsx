      ...
      <div className="flex items-start gap-5 p-6 rounded-2xl bg-surface border border-border">
        ...
        <div className="space-y-1 min-w-0">
          ...
          <p className="text-sm text-muted">
            All tools available to the agent, grouped by category. Tools are registered at startup
            and can be enabled/disabled per group.
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
              {g.tools.map((t) => (
                <div
                  ...
                  title={t.description || ''}
                >
                  <div className="font-mono text-sm font-semibold text-accent group-hover:text-accent/80 mb-1.5 truncate">
                    {t.name}
                  </div>
                  <div className="text-[11px] text-muted leading-relaxed line-clamp-2">
