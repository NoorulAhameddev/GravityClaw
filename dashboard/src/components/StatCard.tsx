  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        <span className="text-[11px] uppercase tracking-wider text-muted-dark font-semibold">
          {label}
        </span>
        {Icon && (
          <Icon
            size={16}
            className="text-muted opacity-40 group-hover:opacity-70 transition-opacity"
          />
        )}
      </div>
