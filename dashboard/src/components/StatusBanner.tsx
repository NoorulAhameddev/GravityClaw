...
export function StatusBanner({ status, uptime, clients, port }: StatusBannerProps) {
    ...
    return (
        <div role="region" aria-label="Server status banner" className={cn(
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-accent/5 via-transparent to-transparent opacity-50" aria-hidden="true" />
