...
describe('Skills System', () => {
  const listSkillsTool = skillManagementTools.find((t) => t.name === 'list_skills');
  const loadSkillTool = skillManagementTools.find((t) => t.name === 'load_skill');
  const disableSkillTool = skillManagementTools.find((t) => t.name === 'disable_skill');
  const reloadSkillsTool = skillManagementTools.find((t) => t.name === 'reload_skills');
