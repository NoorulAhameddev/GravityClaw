...
describe('Group Management', () => {
  ...
  describe('Tool Permissions', () => {
    it('should allow non-dangerous tools for all users', () => {
      const allowed = isToolAllowedForUser('test-telegram', '123456', 'user789', 'datetime');

      expect(allowed).toBe(true);
    });

    it('should restrict dangerous tools to admins', () => {
      const allowed = isToolAllowedForUser('test-telegram', '123456', 'user789', 'run_shell');
    ...
    it('should respect enabled tools list when specified', () => {
      ...
      const allowed1 = isToolAllowedForUser('test-telegram', '123456', 'user789', 'datetime');
