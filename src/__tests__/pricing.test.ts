...
describe('LLM Pricing', () => {
  describe('getModelPricing', () => {
    it('should return pricing for known models', () => {
      ...
      expect(gpt4Pricing.inputPrice).toBe(2.5);
      expect(gpt4Pricing.outputPrice).toBe(10.0);
    ...
    it('should return fallback pricing for unknown models', () => {
      ...
      expect(unknownPricing.inputPrice).toBe(1.0);
      expect(unknownPricing.outputPrice).toBe(3.0);
    ...
    it('should handle fuzzy matching for versioned models', () => {
      ...
      expect(pricing.inputPrice).toBe(30.0); // Should match gpt-4
