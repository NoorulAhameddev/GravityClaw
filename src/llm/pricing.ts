...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  'llama3.2': {
    inputPrice: 0.0, // Local model, no cost
    outputPrice: 0.0,
    contextWindow: 128000,
  },
  llama3: {
...
export function getModelPricing(modelName: string): ModelPricing {
  ...
  return {
    inputPrice: 1.0, // $1 per 1M tokens (generic estimate)
    outputPrice: 3.0, // $3 per 1M tokens (generic estimate)
