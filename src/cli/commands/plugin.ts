...
function getPluginsDir(): string {
  const homeDir =
    process.env.GRAVITYCLAW_HOME ||
    path.join(process.env.HOME || process.env.USERPROFILE || '.', '.gravityclaw');
...
export async function pluginCommand(action?: string, args: string[] = []): Promise<void> {
