...
export const sandboxTool: Tool = {
  name: 'execute_code',
  description:
    'Execute code in an experimental process-limited runner. Supports JavaScript/TypeScript and Python with timeout and pattern blocking; this is not a hardened OS sandbox.',
  inputSchema: {
