...
export function checkTokenBudget(
    ...
    if (!config.TOKEN_BUDGET_ENABLED || budget === null || budget <= 0) {
    ...
    const isDiminishing =
        ...
        deltaSinceLastCheck < config.TOKEN_BUDGET_DIMINISHING_THRESHOLD &&
        tracker.lastDeltaTokens < config.TOKEN_BUDGET_DIMINISHING_THRESHOLD;
